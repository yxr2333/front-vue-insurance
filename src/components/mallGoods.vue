    ...
    <div style="">
      <div class="good-img">
        <a @click="openProduct(msg.id)">
          <img v-lazy="msg.planImgUrl" :alt="msg.name" :key="msg.planImgUrl">
        </a>
      </div>
      <h6 class="good-title" v-html="msg.name">{{msg.name}}</h6>
      <h3 class="sub-title ellipsis">{{msg.intro}}</h3>
      <div class="good-price pr" style="margin-bottom: 5px">
      ...
      <div class="ds pa">
    <a @click="openProduct(msg.id)">
      <y-button text="查看详情" style="margin: 0 5px;width:150px;"></y-button>
    </a>
    <!-- <y-button text="加入购物车"
              style="margin: 0 5px"
